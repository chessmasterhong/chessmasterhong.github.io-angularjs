        ...
        var projects = [
            {
                ...
                thumbnail: CONFIG.PATH.IMG.PROJ_THUMB + 'ia.jpg',
                ...
                slides: [
                    { image: CONFIG.PATH.IMG.PROJ + 'ia/0.jpg', caption: 'It\'s a rainy day.' },
                    { image: CONFIG.PATH.IMG.PROJ + 'ia/1.jpg', caption: 'Sunset.' },
                    { image: CONFIG.PATH.IMG.PROJ + 'ia/2.jpg', caption: 'Nighttime.' },
                    { image: CONFIG.PATH.IMG.PROJ + 'ia/3.jpg', caption: 'Fog effect using Perlin Noise.' },
                    { image: CONFIG.PATH.IMG.PROJ + 'ia/4.jpg', caption: 'Let it snow!' }
                ]
            },
            {
                title: 'Fire Emblem: Chronicles of the Abyss',
                thumbnail: CONFIG.PATH.IMG.PROJ_THUMB + 'fe.jpg',
                ...
                slides: [
                    { image: CONFIG.PATH.IMG.PROJ + 'fe/0.jpg', caption: 'Player unit preparing to attack an enemy unit.' },
                    { image: CONFIG.PATH.IMG.PROJ + 'fe/1.jpg', caption: 'Battle animations between a player unit and enemy unit.' }
                ]
            },
            {
                title: 'Super Mario World: Koopa Krisis',
                thumbnail: CONFIG.PATH.IMG.PROJ_THUMB + 'smw.jpg',
                ...
                slides: [
                    { image: CONFIG.PATH.IMG.PROJ + 'smw/0.jpg', caption: 'Title screen.' }
                ]
            },
            {
                title: 'MathFlash',
                thumbnail: CONFIG.PATH.IMG.PROJ_THUMB + 'mf.jpg',
                ...
                slides: [
                    { image: CONFIG.PATH.IMG.PROJ + 'mf/0.jpg', caption: 'Table of contents of topics.' }
                ]
            },
            {
                title: 'ImpactJS Enemy Editor',
                thumbnail: CONFIG.PATH.IMG.PROJ_THUMB + 'ee.jpg',
                ...
                slides: [
                    { image: CONFIG.PATH.IMG.PROJ + 'ee/0.jpg', caption: 'View all enemies\' data in a project through an organized table. Efficiently batch edit multiple enemy data.' },
                    { image: CONFIG.PATH.IMG.PROJ + 'ee/1.jpg', caption: 'View enemy\'s data in a simple, easy to understand layout.' },
                    { image: CONFIG.PATH.IMG.PROJ + 'ee/2.jpg', caption: 'Quickly edit enemy\'s data using dynamic forms parsed from the enemy\'s source code.' }
                ]
            },
            {
                title: 'ParallelText',
                thumbnail: CONFIG.PATH.IMG.PROJ_THUMB + 'pt.jpg',
                ...
                slides: [
                    { image: CONFIG.PATH.IMG.PROJ + 'pt/0.jpg', caption: 'Home page.' },
                    { image: CONFIG.PATH.IMG.PROJ + 'pt/1.jpg', caption: 'Select a text, a chapter of the specified text, and the languages to display on the left-hand-side and right-hand-side.' },
                    { image: CONFIG.PATH.IMG.PROJ + 'pt/2.jpg', caption: 'The resulting text displayed in parallel in two different languages' }
                ]
            },
            {
                title: 'DocShare',
                thumbnail: CONFIG.PATH.IMG.PROJ_THUMB + 'ds.jpg',
                ...
                slides: [
                    { image: CONFIG.PATH.IMG.PROJ + 'ds/0.jpg', caption: 'Users will be notified of important events related to themselves or their documents via the notification system.' },
                    { image: CONFIG.PATH.IMG.PROJ + 'ds/1.jpg', caption: 'Users are able to edit documents, grant access, or delete documents based on their current privilege on the document.' },
                    { image: CONFIG.PATH.IMG.PROJ + 'ds/2.jpg', caption: 'Users are able to iew their invitations to specific documents and decide whether to accept or decline.' },
                    { image: CONFIG.PATH.IMG.PROJ + 'ds/3.jpg', caption: 'Users are able to view their own or another user\'s profile.' }
                ]
            }
        ];
