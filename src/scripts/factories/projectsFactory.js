        ...
        var projects = [
            {
                ...
                thumbnail: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgdGhDT20yRmVWbzQ',
                ...
                slides: [
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgSXZqNzJUemt1V3M', caption: 'It\'s a rainy day.' },
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgY3A2UnpmRUVDaDQ', caption: 'Sunset.' },
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgaXl0UUJiZmVLVG8', caption: 'Nighttime.' },
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgNFZvMFp5d1lsNGM', caption: 'Fog effect using Perlin Noise.' },
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgSXBMNjFBX1lUZ00', caption: 'Let it snow!' }
                ]
            },
            {
                title: 'Fire Emblem: Chronicles of the Abyss',
                thumbnail: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgd1hLaDg2MHNJVVk',
                ...
                slides: [
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgak81MzBFN0dlWVU', caption: 'Player unit preparing to attack an enemy unit.' },
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgZGNNVHNkTDQ3UGM', caption: 'Battle animations between a player unit and enemy unit.' }
                ]
            },
            {
                title: 'Super Mario World: Koopa Krisis',
                thumbnail: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgNWJFNnYtTk1pMjA',
                ...
                slides: [
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgZEZJdHhzYW5rQTg', caption: 'Title screen.' }
                ]
            },
            {
                title: 'MathFlash',
                thumbnail: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgR0Q1TFdPdnBqWHc',
                ...
                slides: [
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgejZ6ZGxtOVZiNTQ', caption: 'Table of contents of topics.' }
                ]
            },
            {
                title: 'ImpactJS Enemy Editor',
                thumbnail: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgQ1YyVHhrYU93dkk',
                ...
                slides: [
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgRjQ5aUxxTXlHR0E', caption: 'View all enemies\' data in a project through an organized table. Efficiently batch edit multiple enemy data.' },
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgQXY5LWx0b1dRWVE', caption: 'View enemy\'s data in a simple, easy to understand layout.' },
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgQThiRlBFZ1Q2cXM', caption: 'Quickly edit enemy\'s data using dynamic forms parsed from the enemy\'s source code.' }
                ]
            },
            {
                title: 'ParallelText',
                thumbnail: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgLWs3a2pabG9yWms',
                ...
                slides: [
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgM1h5aWlyWmZ1b1U', caption: 'Home page.' },
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgZEs0Ym1tWklVMm8', caption: 'Select a text, a chapter of the specified text, and the languages to display on the left-hand-side and right-hand-side.' },
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgc0FrQ0xqQmNpeTQ', caption: 'The resulting text displayed in parallel in two different languages' }
                ]
            },
            {
                title: 'DocShare',
                thumbnail: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgTTJHZGl2Y3F3Rjg',
                ...
                slides: [
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgWVc1anBmUU4yUE0', caption: 'Users will be notified of important events related to themselves or their documents via the notification system.' },
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgY21IcDl2N2xMVzA', caption: 'Users are able to edit documents, grant access, or delete documents based on their current privilege on the document.' },
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgaTZxT3pxS0lWRGM', caption: 'Users are able to iew their invitations to specific documents and decide whether to accept or decline.' },
                    { image: 'http://drive.google.com/uc?export=download&id=0BzK_sWmObWZgdG1iMzdDQ2FWNTg', caption: 'Users are able to view their own or another user\'s profile.' }
                ]
            }
        ];
