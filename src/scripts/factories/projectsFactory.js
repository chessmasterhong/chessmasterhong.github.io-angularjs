        ...
        var projects = [
            {
                ...
                slides: [
                    { image: CONFIG.PATH.IMG + 'ia0.jpg', caption: 'It\'s a rainy day.' },
                    { image: CONFIG.PATH.IMG + 'ia1.jpg', caption: 'Sunset.' },
                    { image: CONFIG.PATH.IMG + 'ia2.jpg', caption: 'Nighttime.' },
                    { image: CONFIG.PATH.IMG + 'ia3.jpg', caption: 'Fog effect using Perlin Noise.' },
                    { image: CONFIG.PATH.IMG + 'ia4.jpg', caption: 'Let it snow!' }
                ]
            },
            {
